...
for i in range(nreps):
    ...
    aE_t, aI_t, re, ri, rx, stdre, units_sample, connections_sample, QJ, n_neurons, original_tuned_ids, original_prefori = md.make_simulation(units, connections, rates, kee, N, best_pars[id,0], best_pars[id,1], hEI=best_pars[id,4], hII=best_pars[id,5],  
                                                                                                                                    theta_E=20., sigma_tE=best_pars[id,2], theta_I=20.0, sigma_tI=best_pars[id,3], cos_b=betas,
    ...
    for reshuffle_mode in ['all', 'L23', 'L4']:
        aE_t, aI_t, re, ri, stdre, units_reshuffle, connections_reshuffle, QJ_reshuffle = md.make_simulation_fixed_structure(units_sample, connections_sample, QJ, rx, n_neurons, theta_E=20., sigma_tE=best_pars[id, 2], hEI=best_pars[id, 4], hII=best_pars[id, 5], theta_I=20., sigma_tI=best_pars[id,3],
