...
np.save(f'{datafolder}/model/simulations/{savefolder}/shortoptiresultsingle{simid}_pars',  result.x)
np.save(f'{datafolder}/model/simulations/{savefolder}/shortoptiresultsingle{simid}_error', simerror)
